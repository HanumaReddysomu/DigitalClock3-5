...
function alarmFunction()
{
    ...
    var userGivehh=document.getElementById("userHours").value
    var userGivemm=document.getElementById("userMin").value
    var userGiveam_pm=document.getElementById("userAm_Pm").value
    console.log(hh,mm,am_pm)
    console.log(userGivehh,userGivemm,userGiveam_pm)

    if(hh==userGivehh && mm==userGivemm && am_pm==userGiveam_pm)
    {
        audio.play()
        audio.loop=Infinity
    }
